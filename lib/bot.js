...
const RESPONSE_SEMI = 'semi-minimal'
...
class Bot {
  ...
  issueResponse (issue, usrFormat) {
    ...
    response.pretext = `Saved you a ctrl-c ctrl-v :grinning: Here is some information on ${issue.key}`;
    ...
    if (format === RESPONSE_SEMI) {
      ...
      response.fields.push({
        title: 'Story Points',
        value: issue.fields.customfield_10012,
        short: true
      });
    }
